#!/bin/sh
# =====================================================
# VIVERE PLATFORM – WAREHOUSE SERVICE (ENTRYPOINT REVISADO)
# =====================================================
set -e

echo "=================================================="
echo "🚀 Inicializando: ${SERVICE_NAME:-warehouse-service}"
echo "🌎 Ambiente: ${NODE_ENV:-development}"
echo "🗄  Banco: ${DATABASE_HOST:-warehouse-db}:${DATABASE_PORT:-5432}"
echo "=================================================="
...
if [ "${RUN_POST_SQL:-false}" = "true" ]; then
    POST_SCRIPT="./prisma/warehouse_db_post_prisma.sql"
...
echo "🔥 Iniciando Warehouse Service (node dist/main.js)..."
